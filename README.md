...
6. **Red eléctrica** — las máquinas solo funcionan **conectadas a la red**: se enchufan solas al HUB (que suministra 10 MW) o a un generador cercano. Para llegar más lejos, construye **postes eléctricos**: cada poste admite **3 conexiones que trazas tú mismo** (selecciónalo, pulsa "Trazar cable" y toca el destino; cuesta 1 Cable y puedes cortarlas cuando quieras). Quema biomasa (arbustos y árboles) en el Quemador y, más tarde, carbón por cinta en el Generador de carbón. Si la demanda supera la generación, la red se sobrecarga.
