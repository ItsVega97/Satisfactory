...
7. **HUB y HUD** — la **misión actual siempre visible** en pantalla (bajo el indicador eléctrico, con los iconos de cada material y su progreso) y en el HUB el histórico completo de misiones y el banco de artesanía. El HUB, los contenedores, mineros, máquinas y generadores **muestran su contenido sobre el edificio** en el propio mapa con una mini-lista de icono y cantidad (los mineros indican siempre qué mineral extraen, aunque tapen el yacimiento). Los yacimientos son **escasos (3-4 por tipo)** y están lejos de la base: tocará explorar y tender cintas largas.
6. **Red eléctrica 100% manual** — todo se conecta trazando cables (selecciona un edificio, pulsa "Trazar cable" y toca el destino; cuesta 1 Cable y puedes cortarlos). Las máquinas, generadores y el HUB (10 MW) admiten **1 solo cable**; los **postes eléctricos** admiten **3** y reparten la energía por el resto de la red. Quema biomasa (arbustos y árboles) en el Quemador y, más tarde, carbón por cinta en el Generador de carbón. Si la demanda supera la generación, la red se sobrecarga.
